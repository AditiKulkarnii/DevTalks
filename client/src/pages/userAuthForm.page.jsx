    ...
    return (
        access_token ?
            ...
            <AnimationWrapper keyValue={type}>
                <section className="h-cover flex items-center justify-center border-b border-grey">
                    <Toaster />
                    <form id="formElement" className="w-[80%] max-w-[400px]">
                        ...
                        {type === "sign-in" &&
                            <Link to="/forgot-password" className="block text-center mt-4 text-blue-600 underline">
                                Forgot Password?
                            </Link>
                        }
