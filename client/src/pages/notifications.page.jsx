...
const Notification = () => {
    const { userAuth, setUserAuth, userAuth: { access_token, new_notification_available, username: currentUser } } = useContext(UserContext);
    ...
    const fetchNotifications = ({ page, deletedDocCount = 0 }) => {
        axios.post(import.meta.env.VITE_SERVER_DOMAIN + '/notifications-new', {
